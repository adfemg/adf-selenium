...
public class AutomationDisabledException extends WebDriverException {
    ...
    private static final String DFLT_MSG =
        "oracle.adf.view.rich.automation.ENABLED should be set to true in web.xml or as a system property and ADF Faces automation JAR should be included in application";
